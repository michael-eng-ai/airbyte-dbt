#!/bin/bash
# Script helper para carregar variáveis de ambiente
# Uso: source config/load_env.sh

set -a  # Export todas as variáveis automaticamente
source "$(dirname "${BASH_SOURCE[0]}")/env.config"
set +a  # Desligar export automático
...
export ECOMMERCE_API_PORT CRM_API_PORT AIRBYTE_WEBAPP_PORT AIRBYTE_SERVER_PORT AIRBYTE_TEMPORAL_PORT
